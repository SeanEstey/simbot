...
# Pre-fork vars
UberTask.flsk_app = app = create_app('app', mongo_client=False)
...
#-------------------------------------------------------------------------------
@task_prerun.connect
def task_init(signal=None, sender=None, task_id=None, task=None,
              *args, **kwargs):
...
def task_done(signal=None, sender=None, task_id=None, task=None, retval=None, state=None,
              *args, **kwargs):
...
def task_failed(signal=None, sender=None, task_id=None, exception=None, traceback=None, einfo=None,
                *args, **kwargs):
...
def task_killed(sender=None, task_id=None, request=None, terminated=None, signum=None, expired=None,
                *args, **kwargs):
